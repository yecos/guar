    ...
    */
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            ...
            i();
            return this.f2056q && this.f2054o;
        }
        this.f2053n = true;
        this.f2051l = false;
        this.f2040a.l(d(0, motionEvent.getX(), view.getWidth(), this.f2042c.getWidth()), d(1, motionEvent.getY(), view.getHeight(), this.f2042c.getHeight()));
        if (!this.f2054o && u()) {
            v();
        }
        if (this.f2056q) {
