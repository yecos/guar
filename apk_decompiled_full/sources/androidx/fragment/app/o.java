...
public abstract class o {
    ...
    */
    public void S0(Fragment fragment, int i10) {
        ...
        int i11 = 1;
        if (m10 == null) {
            m10 = new v(this.f2352o, this.f2340c, fragment);
            m10.u(1);
        }
        ...
        if (i12 <= min) {
            if (i12 < min && !this.f2350m.isEmpty()) {
                n(fragment);
            }
                ...
                if (i12 != 1) {
                    if (i12 != 2) {
                        ...
                        if (min < 4) {
                            ...
                            if (fragment.mView != null && this.f2355r.l(fragment) && fragment.mSavedViewState == null) {
                                m10.t();
                            }
                        }
                    }
                    if (min < 2) {
                        ...
                        if (view != null && (viewGroup = fragment.mContainer) != null) {
                            ...
                            if (!fragment.isRemovingParent()) {
                                f.d c10 = (this.f2354q <= -1 || this.G || fragment.mView.getVisibility() != 0 || fragment.mPostponedAlpha < 0.0f) ? null : androidx.fragment.app.f.c(this.f2355r.f(), fragment, false, fragment.getPopDirection());
                                fragment.mPostponedAlpha = 0.0f;
                                ViewGroup viewGroup2 = fragment.mContainer;
                                View view2 = fragment.mView;
                                if (c10 != null) {
                                    androidx.fragment.app.f.a(fragment, c10, this.f2351n);
                                }
    ...
    */
    public final void d0(ArrayList arrayList, ArrayList arrayList2, int i10, int i11) {
        ...
        boolean z11;
        int i17;
        boolean z12 = ((androidx.fragment.app.a) arrayList.get(i10)).f2451r;
        ...
        this.K.addAll(this.f2340c.n());
        Fragment x02 = x0();
        boolean z13 = false;
        for (int i18 = i10; i18 < i11; i18++) {
            androidx.fragment.app.a aVar = (androidx.fragment.app.a) arrayList.get(i18);
            x02 = !((Boolean) arrayList2.get(i18)).booleanValue() ? aVar.B(this.K, x02) : aVar.J(this.K, x02);
            z13 = z13 || aVar.f2442i;
        }
        this.K.clear();
        if (!z12 && this.f2354q >= 1) {
            if (!P) {
                r12 = 1;
                z.B(this.f2355r.f(), this.f2356s, arrayList, arrayList2, i10, i11, false, this.f2351n);
                ...
                if (P) {
                    ...
                    if (i15 == i13 || !z10) {
                        ...
                        if (this.f2354q >= i14) {
                            ...
                            i16 = i12;
                            z11 = true;
                            z.B(this.f2355r.f(), this.f2356s, arrayList, arrayList2, i10, i19, true, this.f2351n);
                        } else {
                            arrayList4 = arrayList3;
                            i16 = i12;
                            z11 = true;
                    ...
                    for (int i20 = i10; i20 < i11; i20++) {
                        ...
                        if (booleanValue) {
                            for (int size = aVar2.f2436c.size() - r12; size >= 0; size--) {
                                Fragment fragment = ((y.a) aVar2.f2436c.get(size)).f2454b;
                                if (fragment != null) {
                                    v(fragment).m();
                                }
                            }
                        } else {
                            Iterator it = aVar2.f2436c.iterator();
                            while (it.hasNext()) {
                                Fragment fragment2 = ((y.a) it.next()).f2454b;
                                if (fragment2 != null) {
                                    v(fragment2).m();
                                }
                            }
                    ...
                    Q0(this.f2354q, r12);
                    for (j0 j0Var : s(arrayList, i10, i11)) {
                ...
                for (i17 = i10; i17 < i16; i17++) {
                    ...
                    if (((Boolean) arrayList4.get(i17)).booleanValue() && aVar3.f2175v >= 0) {
                        aVar3.f2175v = -1;
                    }
                    aVar3.H();
                }
            ...
            for (int i21 = i10; i21 < i11; i21++) {
                Iterator it2 = ((androidx.fragment.app.a) arrayList.get(i21)).f2436c.iterator();
                while (it2.hasNext()) {
                    Fragment fragment3 = ((y.a) it2.next()).f2454b;
                    if (fragment3 != null && fragment3.mFragmentManager != null) {
                        this.f2340c.p(v(fragment3));
                    }
                }
            }
        }
