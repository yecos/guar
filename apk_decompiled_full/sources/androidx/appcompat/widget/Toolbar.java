...
public class Toolbar extends ViewGroup {
    ...
    */
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        iArr[0] = 0;
        int A = b0.c1.A(this);
        int min = A >= 0 ? Math.min(A, i13 - i11) : 0;
        if (!u(this.mNavButtonView)) {
            ...
            if (z11) {
                ...
                u10 = u(this.mTitleTextView);
                u11 = u(this.mSubtitleTextView);
                if (u10) {
                    i16 = paddingRight;
                    i17 = 0;
                } else {
                ...
                if (!u10 || u11) {
                    TextView textView = !u10 ? this.mTitleTextView : this.mSubtitleTextView;
                    TextView textView2 = !u11 ? this.mSubtitleTextView : this.mTitleTextView;
                    e eVar3 = (e) textView.getLayoutParams();
                    e eVar4 = (e) textView2.getLayoutParams();
                    boolean z12 = (!u10 && this.mTitleTextView.getMeasuredWidth() > 0) || (u11 && this.mSubtitleTextView.getMeasuredWidth() > 0);
                    ...
                    if (z11) {
                        ...
                        if (u11) {
                            ...
                            i26 = measuredWidth2 + this.mTitleMarginEnd;
                        } else {
                            i26 = max;
                        }
                        if (z12) {
                        ...
                        for (i29 = 0; i29 < size; i29++) {
                            max = o(this.mTempViews.get(i29), max, iArr, i22);
                        }
                        int i41 = i22;
                        a(this.mTempViews, 5);
                        size2 = this.mTempViews.size();
                        for (i30 = 0; i30 < size2; i30++) {
                            min2 = p(this.mTempViews.get(i30), min2, iArr, i41);
                        }
                        a(this.mTempViews, 1);
                        ...
                        while (i23 < size3) {
                            max = o(this.mTempViews.get(i23), max, iArr, i41);
                            i23++;
                        }
                    ...
                    if (u10) {
                        ...
                        i27 = measuredWidth3 - this.mTitleMarginEnd;
                        paddingTop = measuredHeight2 + ((ViewGroup.MarginLayoutParams) eVar6).bottomMargin;
                    } else {
                        i27 = min2;
                    }
                    if (u11) {
                        int i44 = paddingTop + ((ViewGroup.MarginLayoutParams) ((e) this.mSubtitleTextView.getLayoutParams())).topMargin;
