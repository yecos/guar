...
public class h extends androidx.appcompat.app.f implements g.a, LayoutInflater.Factory2 {
    ...
    */
    public g.b D0(b.a aVar) {
        ...
        androidx.appcompat.app.e eVar2 = this.f928h;
        if (eVar2 != null && !this.M) {
            ...
            if (bVar == null) {
                ...
                if (this.f938p == null) {
                    if (this.D) {
                        TypedValue typedValue = new TypedValue();
                        Resources.Theme theme = this.f923e.getTheme();
                        theme.resolveAttribute(R$attr.actionBarTheme, typedValue, true);
                        if (typedValue.resourceId != 0) {
                            Resources.Theme newTheme = this.f923e.getResources().newTheme();
                            newTheme.setTo(theme);
                            newTheme.applyStyle(typedValue.resourceId, true);
                            context = new g.d(this.f923e, 0);
                            context.getTheme().setTo(newTheme);
                        } else {
                            context = this.f923e;
                        }
                        this.f938p = new ActionBarContextView(context);
                        PopupWindow popupWindow = new PopupWindow(context, (AttributeSet) null, R$attr.actionModePopupWindowStyle);
                        this.f939q = popupWindow;
                        t.b(popupWindow, 2);
                        this.f939q.setContentView(this.f938p);
                        this.f939q.setWidth(-1);
                        context.getTheme().resolveAttribute(R$attr.actionBarSize, typedValue, true);
                        this.f938p.setContentHeight(TypedValue.complexToDimensionPixelSize(typedValue.data, context.getResources().getDisplayMetrics()));
                        this.f939q.setHeight(-2);
                        this.f940r = new f();
                    } else {
                        ViewStubCompat viewStubCompat = (ViewStubCompat) this.f944v.findViewById(R$id.action_mode_bar_stub);
                        if (viewStubCompat != null) {
                            viewStubCompat.setLayoutInflater(LayoutInflater.from(Y()));
                            this.f938p = (ActionBarContextView) viewStubCompat.a();
                        }
                    }
                }
                if (this.f938p != null) {
                    U();
                    this.f938p.k();
                    g.e eVar3 = new g.e(this.f938p.getContext(), this.f938p, aVar, this.f939q == null);
                    if (aVar.d(eVar3, eVar3.c())) {
                        eVar3.i();
                        this.f938p.h(eVar3);
                        this.f937o = eVar3;
                        if (B0()) {
                            this.f938p.setAlpha(0.0f);
                            a2 a10 = c1.c(this.f938p).a(1.0f);
                            this.f941s = a10;
                            a10.f(new g());
                        } else {
                            this.f938p.setAlpha(1.0f);
                            this.f938p.setVisibility(0);
                            this.f938p.sendAccessibilityEvent(32);
                            if (this.f938p.getParent() instanceof View) {
                                c1.h0((View) this.f938p.getParent());
                            }
                        }
                        if (this.f939q != null) {
                            this.f924f.getDecorView().post(this.f940r);
                        }
                    } else {
                        this.f937o = null;
                    }
            ...
            bVar2 = this.f937o;
            if (bVar2 != null && (eVar = this.f928h) != null) {
