...
public class c extends androidx.appcompat.app.c {
        ...
        */
        public Bitmap doInBackground(Void... voidArr) {
                    ...
                    if (uri != null) {
                        try {
                            ...
                            try {
                                ...
                                options.inSampleSize = Math.max(1, Integer.highestOneBit(options.outHeight / c.this.i(options.outWidth, options.outHeight)));
                                if (isCancelled()) {
                                    try {
                                        inputStream.close();
            ...
            if (bitmap != null && bitmap.getWidth() < bitmap.getHeight()) {
                ...
                this.f2832c = a10.f().isEmpty() ? 0 : ((b.d) a10.f().get(0)).e();
            }
            return bitmap;
        }
    ...
    */
    public final void E() {
        ...
        if (this.f2770c.p() != -1) {
            this.f2799s.setText(R$string.mr_controller_casting_screen);
        } else {
            PlaybackStateCompat playbackStateCompat2 = this.S;
            if (playbackStateCompat2 == null || playbackStateCompat2.g() == 0) {
                this.f2799s.setText(R$string.mr_controller_no_media_selected);
            } else if (z13 || z14) {
                if (z13) {
                    this.f2799s.setText(f10);
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (z14) {
                    this.f2801t.setText(e10);
                    z11 = true;
                    this.f2799s.setVisibility(z10 ? 0 : 8);
                    this.f2801t.setVisibility(z11 ? 0 : 8);
                    playbackStateCompat = this.S;
                    if (playbackStateCompat != null) {
                        boolean z15 = playbackStateCompat.g() == 6 || this.S.g() == 3;
                        Context context = this.f2783k.getContext();
                        if (z15 && n()) {
                        ...
                        this.f2783k.setVisibility(z12 ? 0 : 8);
                        if (z12) {
                            this.f2783k.setImageResource(androidx.mediarouter.app.i.p(context, i10));
                            this.f2783k.setContentDescription(context.getResources().getText(i11));
                            return;
                        }
                        return;
                    }
                ...
                this.f2799s.setText(R$string.mr_controller_no_info_available);
            }
        }
        z10 = true;
        z11 = false;
    ...
    */
    public c(Context context, int i10) {
        ...
        Context b10 = androidx.mediarouter.app.i.b(context, i10, true);
        this.f2805v = true;
        this.f2804u0 = new d();
        this.f2771d = getContext();
        this.Q = new o();
        t0 i11 = t0.i(this.f2771d);
        this.f2768a = i11;
        this.f2769b = new p();
        this.f2770c = i11.m();
        v(i11.j());
        this.M = this.f2771d.getResources().getDimensionPixelSize(R$dimen.mr_controller_volume_group_list_padding_top);
        this.f2802t0 = (AccessibilityManager) this.f2771d.getSystemService("accessibility");
        if (Build.VERSION.SDK_INT >= 21) {
            this.f2796q0 = AnimationUtils.loadInterpolator(b10, R$interpolator.mr_linear_out_slow_in);
            this.f2798r0 = AnimationUtils.loadInterpolator(b10, R$interpolator.mr_fast_out_slow_in);
        }
        this.f2800s0 = new AccelerateDecelerateInterpolator();
    }
}
