    ...
    public boolean arrowScroll(int i10) {
        ...
        if (findFocus != this) {
            ...
            if (findNextFocus == null && findNextFocus != findFocus) {
                if (i10 == 17) {
                    requestFocus = (findFocus == null || i(this.mTempRect, findNextFocus).left < i(this.mTempRect, findFocus).left) ? findNextFocus.requestFocus() : pageLeft();
                } else if (i10 == 66) {
                    requestFocus = (findFocus == null || i(this.mTempRect, findNextFocus).left > i(this.mTempRect, findFocus).left) ? findNextFocus.requestFocus() : pageRight();
                }
                z11 = requestFocus;
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i27 = 0; i27 < childCount; i27++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!gVar2.f3567a && (infoForChild = infoForChild(childAt2)) != null) {
                    float f10 = i26;
                    int i28 = ((int) (infoForChild.f3566e * f10)) + paddingLeft;
                    if (gVar2.f3570d) {
                        gVar2.f3570d = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f10 * gVar2.f3569c), Ints.MAX_POWER_OF_TWO), View.MeasureSpec.makeMeasureSpec((i17 - paddingTop) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                    }
    ...
    */
    public void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8 && (gVar2 = (g) childAt.getLayoutParams()) != null && gVar2.f3567a) {
                int i17 = gVar2.f3568b;
                int i18 = i17 & 7;
                int i19 = i17 & 112;
        ...
        for (int i21 = 0; i21 < childCount2; i21++) {
            ...
            if (childAt2.getVisibility() != 8 && ((gVar = (g) childAt2.getLayoutParams()) == null || !gVar.f3567a)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * gVar.f3569c), Ints.MAX_POWER_OF_TWO), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    public void onPageScrolled(int i10, float f10, int i11) {
        ...
        if (this.mPageTransformer != null) {
            ...
            for (int i16 = 0; i16 < childCount2; i16++) {
                ...
                if (!((g) childAt2.getLayoutParams()).f3567a) {
    ...
    */
    public void populate(int i10) {
        ...
        if (fVar2 != null) {
            ...
            int clientWidth = getClientWidth();
            float paddingLeft = clientWidth <= 0 ? 0.0f : (2.0f - fVar2.f3565d) + (getPaddingLeft() / clientWidth);
            float f10 = 0.0f;
            for (int i17 = this.mCurItem - 1; i17 >= 0; i17--) {
                if (f10 >= paddingLeft && i17 < max) {
                    ...
                    if (i17 == fVar4.f3563b && !fVar4.f3564c) {
                        this.mItems.remove(i16);
                        this.mAdapter.destroyItem((ViewGroup) this, i17, fVar4.f3562a);
                        i16--;
                        i13--;
                        if (i16 >= 0) {
                ...
                } else if (fVar4 == null || i17 != fVar4.f3563b) {
                    f10 += addNewItem(i17, i16 + 1).f3565d;
                    i13++;
                    if (i16 >= 0) {
                        fVar3 = this.mItems.get(i16);
                        fVar4 = fVar3;
            ...
            if (f11 < 2.0f) {
                ...
                while (true) {
                    ...
                    if (f11 >= paddingRight && i19 > min) {
                        ...
                        if (i19 == fVar5.f3563b && !fVar5.f3564c) {
                            this.mItems.remove(i18);
                            this.mAdapter.destroyItem((ViewGroup) this, i19, fVar5.f3562a);
                            if (i18 < this.mItems.size()) {
                                fVar5 = this.mItems.get(i18);
                            }
                        }
                    } else if (fVar5 == null || i19 != fVar5.f3563b) {
                        f addNewItem = addNewItem(i19, i18);
                        i18++;
                        f11 += addNewItem.f3565d;
            ...
            a(fVar2, i13, fVar);
            this.mAdapter.setPrimaryItem((ViewGroup) this, this.mCurItem, fVar2.f3562a);
        }
        this.mAdapter.finishUpdate((ViewGroup) this);
        int childCount = getChildCount();
        for (int i20 = 0; i20 < childCount; i20++) {
            ...
            g gVar = (g) childAt.getLayoutParams();
            gVar.f3572f = i20;
            if (!gVar.f3567a && gVar.f3569c == 0.0f && (infoForChild = infoForChild(childAt)) != null) {
                gVar.f3569c = infoForChild.f3565d;
                gVar.f3571e = infoForChild.f3563b;
            }
        }
        u();
        if (hasFocus()) {
            ...
            if (infoForAnyChild == null || infoForAnyChild.f3563b != this.mCurItem) {
                for (int i21 = 0; i21 < getChildCount(); i21++) {
                    View childAt2 = getChildAt(i21);
                    f infoForChild2 = infoForChild(childAt2);
                    if (infoForChild2 != null && infoForChild2.f3563b == this.mCurItem && childAt2.requestFocus(2)) {
                        return;
                    }
                }
            }
