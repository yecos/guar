...
public class RecyclerView extends ViewGroup implements b0.v {
    ...
    public final class v {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public d0 I(int i10, boolean z10, long j10) {
            d0 d0Var;
            boolean z11;
            d0 d0Var2;
            boolean z12;
            ...
            if (RecyclerView.this.mState.e()) {
                ...
                if (d0Var != null) {
                    z11 = true;
                    if (d0Var == null && (d0Var = m(i10, z10)) != null) {
                        if (L(d0Var)) {
                            if (!z10) {
                                d0Var.addFlags(4);
                                if (d0Var.isScrap()) {
                    ...
                    if (d0Var == null) {
                        ...
                        if (RecyclerView.this.mAdapter.hasStableIds() && (d0Var = l(RecyclerView.this.mAdapter.getItemId(m10), itemViewType, z10)) != null) {
                            d0Var.mPosition = m10;
                            z11 = true;
                        }
                        if (d0Var == null) {
                            d0 f10 = i().f(itemViewType);
                            if (f10 != null) {
                                f10.resetInternal();
                        ...
                        if (d0Var == null) {
                            long nanoTime = RecyclerView.this.getNanoTime();
                            if (j10 != RecyclerView.FOREVER_NS && !this.f3068g.l(itemViewType, nanoTime, j10)) {
                                return null;
                            }
                            RecyclerView recyclerView = RecyclerView.this;
                            d0 createViewHolder = recyclerView.mAdapter.createViewHolder(recyclerView, itemViewType);
                            ...
                            this.f3068g.e(itemViewType, RecyclerView.this.getNanoTime() - nanoTime);
                            d0Var2 = createViewHolder;
                            z12 = z11;
                            if (z12 && !RecyclerView.this.mState.e() && d0Var2.hasAnyOfTheFlags(8192)) {
                                d0Var2.setFlags(0, 8192);
                                if (RecyclerView.this.mState.f3017k) {
                                    int e10 = l.e(d0Var2) | 4096;
                                    RecyclerView recyclerView2 = RecyclerView.this;
                                    RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(d0Var2, recyclerView2.mItemAnimator.t(recyclerView2.mState, d0Var2, e10, d0Var2.getUnmodifiedPayloads()));
                                }
                            }
                            if (!RecyclerView.this.mState.e() && d0Var2.isBound()) {
                                d0Var2.mPreLayoutPosition = i10;
                            } else if (d0Var2.isBound() || d0Var2.needsUpdate() || d0Var2.isInvalid()) {
                                H = H(d0Var2, RecyclerView.this.mAdapterHelper.m(i10), i10, j10);
                                layoutParams = d0Var2.itemView.getLayoutParams();
                                if (layoutParams != null) {
                                    pVar = (p) RecyclerView.this.generateDefaultLayoutParams();
                                    d0Var2.itemView.setLayoutParams(pVar);
    ...
    */
    private void pullGlows(float f10, float f11, float f12, float f13) {
        ...
        if (f11 < 0.0f) {
            ensureLeftGlow();
            androidx.core.widget.i.d(this.mLeftGlow, (-f11) / getWidth(), 1.0f - (f12 / getHeight()));
        } else {
            if (f11 <= 0.0f) {
                z10 = false;
                if (f13 >= 0.0f) {
                    ensureTopGlow();
                    androidx.core.widget.i.d(this.mTopGlow, (-f13) / getHeight(), f10 / getWidth());
                } else if (f13 > 0.0f) {
                    ensureBottomGlow();
                    androidx.core.widget.i.d(this.mBottomGlow, f13 / getHeight(), 1.0f - (f10 / getWidth()));
                } else {
                    z11 = z10;
                }
            ...
            ensureRightGlow();
            androidx.core.widget.i.d(this.mRightGlow, f11 / getWidth(), f12 / getHeight());
        }
        z10 = true;
        if (f13 >= 0.0f) {
        }
    ...
    */
    public void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ThreadLocal threadLocal = androidx.recyclerview.widget.e.f3234e;
