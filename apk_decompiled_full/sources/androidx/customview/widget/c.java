    ...
    public boolean H(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                    if (actionMasked != 3) {
                        if (actionMasked == 5) {
                            ...
                            int i10 = this.f2094a;
                            if (i10 == 0) {
                                int i11 = this.f2101h[pointerId];
                                int i12 = this.f2109p;
                                if ((i11 & i12) != 0) {
                                    this.f2111r.onEdgeTouched(i11 & i12, pointerId);
                                }
                            } else if (i10 == 2 && (r10 = r((int) x10, (int) y10)) == this.f2112s) {
                                J(r10, pointerId);
                            }
                ...
                } else if (this.f2097d != null && this.f2098e != null) {
                    int pointerCount = motionEvent.getPointerCount();
                    for (int i13 = 0; i13 < pointerCount; i13++) {
                        ...
                        if (y(pointerId2)) {
                            ...
                            float f10 = x11 - this.f2097d[pointerId2];
                            float f11 = y11 - this.f2098e[pointerId2];
                            View r11 = r((int) x11, (int) y11);
                            boolean z11 = r11 != null && d(r11, f10, f11);
                            if (z11) {
                                int left = r11.getLeft();
                                int i14 = (int) f10;
                                int clampViewPositionHorizontal = this.f2111r.clampViewPositionHorizontal(r11, left + i14, i14);
                                int top = r11.getTop();
                                int i15 = (int) f11;
                                int clampViewPositionVertical = this.f2111r.clampViewPositionVertical(r11, top + i15, i15);
                                int viewHorizontalDragRange = this.f2111r.getViewHorizontalDragRange(r11);
                                int viewVerticalDragRange = this.f2111r.getViewVerticalDragRange(r11);
            ...
            if (r12 == this.f2112s && this.f2094a == 2) {
                J(r12, pointerId3);
            }
            int i16 = this.f2101h[pointerId3];
            int i17 = this.f2109p;
            if ((i16 & i17) != 0) {
                this.f2111r.onEdgeTouched(i16 & i17, pointerId3);
            }
        }
        if (this.f2094a == 1) {
            return true;
