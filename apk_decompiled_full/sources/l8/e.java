...
public final class e {
    ...
    public static final class h implements IMediaPlayer.OnPreparedListener {
        ...
        */
        public final void onPrepared(IMediaPlayer iMediaPlayer) {
            ...
            j8.a a03;
            String str6;
            if (e.this.f16299r == null) {
                return;
            }
            IMediaPlayer Z2 = e.this.Z();
            if (!(Z2 instanceof IjkMediaPlayer)) {
                Z2 = null;
            }
            IjkMediaPlayer ijkMediaPlayer = (IjkMediaPlayer) Z2;
            if (ijkMediaPlayer != null && ijkMediaPlayer.getVideoDecoder() == 1) {
                NativeJni.c().k(e.this.f16296o, "onError", 0, 1101, 0L, "");
                if ((!t9.i.b(e.this.f16307z != null ? r14.d() : null, "")) && (fVar4 = e.this.f16307z) != null && !fVar4.m() && (a03 = e.this.a0()) != null) {
                    int i10 = e.this.f16296o;
                    l8.f fVar5 = e.this.f16307z;
                    if (fVar5 == null || (str6 = fVar5.d()) == null) {
                        str6 = "";
                    }
                    a03.l(i10, 1101, "ijk", str6);
                }
            }
            IMediaPlayer Z3 = e.this.Z();
            if ((Z3 != null ? Z3.getVideoWidth() : 0) == 0) {
                IMediaPlayer Z4 = e.this.Z();
                if ((Z4 != null ? Z4.getVideoHeight() : 0) == 0) {
                    NativeJni.c().k(e.this.f16296o, "onError", 0, 1102, 0L, "");
                    if ((!t9.i.b(e.this.f16307z != null ? r14.d() : null, "")) && (a02 = e.this.a0()) != null) {
                        int i11 = e.this.f16296o;
                        String a10 = e.this.f16301t.a();
                        l8.f fVar6 = e.this.f16307z;
                        if (fVar6 == null || (str5 = fVar6.d()) == null) {
                            str5 = "";
                        }
                        a02.l(i11, 1102, a10, str5);
                    }
                }
            }
            l8.f fVar7 = e.this.f16307z;
            if (t9.i.b((fVar7 == null || (g15 = fVar7.g()) == null) ? null : g15.getBuss(), "vod") && (fVar3 = e.this.f16307z) != null && !fVar3.r() && !ThumbnailUtil.INSTANCE.hasThumbnail() && e.this.Y().c() == 1) {
                ThumbnailRequest thumbnailRequest = ThumbnailRequest.INSTANCE;
                l8.f fVar8 = e.this.f16307z;
                if (fVar8 == null || (str4 = fVar8.l()) == null) {
                    str4 = "";
                }
                thumbnailRequest.getThumbnail(str4);
            }
            e.this.f16287f = true;
            NativeJni.c().k(e.this.f16296o, "onPrepared", 0, 0, 0L, "");
            l8.f fVar9 = e.this.f16307z;
            if (fVar9 != null) {
                fVar9.I(0L);
            }
            if (e.this.f16283b) {
                IMediaPlayer Z5 = e.this.Z();
                if (Z5 != null && Z5.isPlaying() && (Z = e.this.Z()) != null) {
                    Z.pause();
                }
            } else {
                IMediaPlayer Z6 = e.this.Z();
                if (Z6 == null) {
                    t9.i.q();
                }
                Z6.start();
            ...
            if (e.this.f16305x >= 0) {
                e eVar = e.this;
                eVar.D0(eVar.f16305x);
                e.this.f16305x = -1;
            }
            if (e.this.f16301t != i8.b.NATIVE) {
                l8.f fVar10 = e.this.f16307z;
                if ((fVar10 != null ? fVar10.i() : 0L) > 0) {
                    l8.f fVar11 = e.this.f16307z;
                    if (t9.i.b((fVar11 == null || (g14 = fVar11.g()) == null) ? null : g14.getBuss(), "vod") || ((fVar2 = e.this.f16307z) != null && fVar2.s())) {
                        l8.f fVar12 = e.this.f16307z;
                        Long valueOf = fVar12 != null ? Long.valueOf(fVar12.i()) : null;
                        if (valueOf == null) {
                            t9.i.q();
                        }
                        j10 = valueOf.longValue();
                        l8.f fVar13 = e.this.f16307z;
                        if (fVar13 != null) {
                            fVar13.G(0L);
                        }
                        if (j10 > 0) {
                            e eVar2 = e.this;
                            l8.f fVar14 = eVar2.f16307z;
                            if (fVar14 == null || (str3 = fVar14.d()) == null) {
                                str3 = "";
                            }
                            eVar2.C0(str3, j10);
                        }
                ...
                l8.f fVar15 = e.this.f16307z;
                if ((fVar15 != null ? fVar15.j() : -1L) >= 0) {
                    l8.f fVar16 = e.this.f16307z;
                    if (t9.i.b((fVar16 == null || (g13 = fVar16.g()) == null) ? null : g13.getBuss(), "vod") && (fVar = e.this.f16307z) != null && fVar.t()) {
                        l8.f fVar17 = e.this.f16307z;
                        Long valueOf2 = fVar17 != null ? Long.valueOf(fVar17.j()) : null;
                        if (valueOf2 == null) {
                            t9.i.q();
                        }
                        j10 = valueOf2.longValue();
                        l8.f fVar18 = e.this.f16307z;
                        if (fVar18 != null) {
                            fVar18.F(false);
                        }
                        if (j10 > 0) {
                ...
                l8.f fVar19 = e.this.f16307z;
                if (((fVar19 == null || (g12 = fVar19.g()) == null) ? 0L : g12.getStart()) > 0) {
                    l8.f fVar20 = e.this.f16307z;
                    Long valueOf3 = (fVar20 == null || (g11 = fVar20.g()) == null) ? null : Long.valueOf(g11.getStart());
                    if (valueOf3 == null) {
                        t9.i.q();
                    }
                    j10 = valueOf3.longValue();
                    l8.f fVar21 = e.this.f16307z;
                    if (fVar21 != null && (g10 = fVar21.g()) != null) {
                        g10.setStart(0L);
                    }
                } else {
                    j10 = 0;
            ...
            e.this.i0();
            IMediaPlayer Z7 = e.this.Z();
            if (Z7 == null || (mediaInfo = Z7.getMediaInfo()) == null || (ijkMediaMeta = mediaInfo.mMeta) == null || (str = ijkMediaMeta.mFormat) == null) {
                str = "";
            }
            d8.c cVar = e.this.f16306y;
            if (cVar != null) {
            ...
            NativeJni.c().h(e.this.f16296o, IjkMediaMeta.IJKM_KEY_FORMAT, str);
            d8.c cVar2 = e.this.f16306y;
            if (cVar2 != null) {
                cVar2.j(e.this.W());
            }
            NativeJni.c().h(e.this.f16296o, "media_duration", String.valueOf(e.this.W()));
            if ((!t9.i.b(e.this.f16307z != null ? r14.d() : null, "")) && !(e.this.Z() instanceof IjkMediaPlayer)) {
                e.this.f16303v = true;
                d8.c cVar3 = e.this.f16306y;
                if (cVar3 != null) {
                    j8.a a04 = e.this.a0();
                    if (a04 != null) {
                        l8.f fVar22 = e.this.f16307z;
                        if (fVar22 == null || (str2 = fVar22.d()) == null) {
                            str2 = "";
                        }
                        dVar = a04.f(cVar3, str2);
                    } else {
                        dVar = null;
                    }
                    if (dVar != null) {
            ...
            e.this.f16304w = true;
            e.this.S0();
            if (!t9.i.b(e.this.f16307z != null ? r14.d() : null, "")) {
                l8.f fVar23 = e.this.f16307z;
                String str7 = (fVar23 == null || !fVar23.r()) ? "media" : "ad";
                j8.a a05 = e.this.a0();
                if (a05 != null) {
                    int i12 = e.this.f16296o;
                    IMediaPlayer Z8 = e.this.Z();
                    int videoWidth = Z8 != null ? Z8.getVideoWidth() : 0;
                    IMediaPlayer Z9 = e.this.Z();
                    int videoHeight = Z9 != null ? Z9.getVideoHeight() : 0;
                    l8.f fVar24 = e.this.f16307z;
                    a05.h(i12, videoWidth, videoHeight, str7, (fVar24 == null || (d10 = fVar24.d()) == null) ? "" : d10);
                }
            }
        }
    }
    ...
    public static final class i implements IMediaPlayer.OnCompletionListener {
        ...
        */
        public final void onCompletion(IMediaPlayer iMediaPlayer) {
            ...
            d8.c cVar = e.this.f16306y;
            boolean z12 = (cVar != null ? cVar.c() : 0L) > 0;
            l8.f fVar2 = e.this.f16307z;
            if ((fVar2 != null ? fVar2.k() : 0L) > 0) {
                l8.f fVar3 = e.this.f16307z;
                long k10 = fVar3 != null ? fVar3.k() : 0L;
                d8.c cVar2 = e.this.f16306y;
                if (k10 >= (cVar2 != null ? cVar2.c() : 0L) - 120000) {
                    z10 = true;
                    if (e.this.f16288g > 0) {
                        long j10 = e.this.f16288g;
                        d8.c cVar3 = e.this.f16306y;
                        if (j10 >= (cVar3 != null ? cVar3.c() : 0L) - 120000) {
                            z11 = true;
                            if (e.this.Z() == null || !e.this.f16287f) {
                                return;
                            }
                            if (!(z12 && (z10 || z11)) && ((fVar = e.this.f16307z) == null || !fVar.r())) {
                                return;
                            }
                            NativeJni.c().k(e.this.f16296o, "onCompletion", 0, 0, 0L, "");
                            l8.f fVar4 = e.this.f16307z;
                            if (fVar4 != null) {
                                fVar4.w(true);
                            }
                            ...
                            if (!t9.i.b(e.this.f16307z != null ? r1.d() : null, "")) {
                                e.this.p0("end");
                                l8.f fVar5 = e.this.f16307z;
                                String str2 = (fVar5 == null || !fVar5.r()) ? "media" : "ad";
                                j8.a a02 = e.this.a0();
                                if (a02 != null) {
                                    int i10 = e.this.f16296o;
                                    l8.f fVar6 = e.this.f16307z;
                            ...
                            e.this.F0(0);
                            l8.f fVar9 = e.this.f16307z;
                            if ((fVar9 != null ? fVar9.h() : null) != null) {
                                e eVar2 = e.this;
                                l8.f fVar10 = eVar2.f16307z;
                                Status h10 = fVar10 != null ? fVar10.h() : null;
                                if (h10 == null) {
                                    t9.i.q();
                                }
                                eVar2.w0(h10);
    ...
    public static final class k implements IMediaPlayer.OnInfoListener {
        ...
        */
        public final boolean onInfo(IMediaPlayer iMediaPlayer, int i10, int i11) {
            ...
            j8.a a02;
            String d11;
            if (i10 == 701 && e.this.f16284c) {
                NativeJni.c().k(e.this.f16296o, "onInfo", i10, i11, 1L, "");
            } else {
                NativeJni.c().k(e.this.f16296o, "onInfo", i10, i11, 0L, "");
            }
            String str = "";
            Long l10 = null;
            l10 = null;
            if (i10 == 701) {
                e.this.J.removeMessages(61699);
                if ((!t9.i.b(e.this.f16307z != null ? r2.d() : null, "")) && (a02 = e.this.a0()) != null) {
                    int i12 = e.this.f16296o;
                    l8.f fVar3 = e.this.f16307z;
                    a02.c(i12, "buffering", "show", 0, (fVar3 == null || (d11 = fVar3.d()) == null) ? "" : d11);
                }
                l8.f fVar4 = e.this.f16307z;
                if (fVar4 != null) {
                    fVar4.v(true);
                ...
                e.this.F0(3);
                e.this.J.removeMessages(61699);
                e.this.J.sendEmptyMessageDelayed(61699, 1000L);
                e.this.f16284c = false;
            } else if (i10 == 3) {
                e.this.p0("start");
                if (e.this.f16301t == i8.b.NATIVE) {
                    l8.f fVar5 = e.this.f16307z;
                    if ((fVar5 != null ? fVar5.i() : 0L) > 0) {
                        l8.f fVar6 = e.this.f16307z;
                        if (t9.i.b((fVar6 == null || (g14 = fVar6.g()) == null) ? null : g14.getBuss(), "vod") || ((fVar2 = e.this.f16307z) != null && fVar2.s())) {
                            l8.f fVar7 = e.this.f16307z;
                            Long valueOf = fVar7 != null ? Long.valueOf(fVar7.i()) : null;
                            if (valueOf == null) {
                                t9.i.q();
                            }
                            j10 = valueOf.longValue();
                            ...
                            if (j10 > 0) {
                                ...
                                if ((cVar != null ? cVar.c() : 0L) > 0) {
                                    e eVar = e.this;
                                    l8.f fVar9 = eVar.f16307z;
                                    if (fVar9 != null && (d10 = fVar9.d()) != null) {
                                        str = d10;
                                    }
                                    eVar.C0(str, j10);
                                }
                    ...
                    l8.f fVar10 = e.this.f16307z;
                    if ((fVar10 != null ? fVar10.j() : -1L) >= 0) {
                        l8.f fVar11 = e.this.f16307z;
                        if (t9.i.b((fVar11 == null || (g13 = fVar11.g()) == null) ? null : g13.getBuss(), "vod") && (fVar = e.this.f16307z) != null && fVar.t()) {
                            l8.f fVar12 = e.this.f16307z;
                            Long valueOf2 = fVar12 != null ? Long.valueOf(fVar12.j()) : null;
                            if (valueOf2 == null) {
                                t9.i.q();
                            }
                            j10 = valueOf2.longValue();
                    ...
                    l8.f fVar14 = e.this.f16307z;
                    if (((fVar14 == null || (g12 = fVar14.g()) == null) ? 0L : g12.getStart()) > 0) {
                        l8.f fVar15 = e.this.f16307z;
                        if (fVar15 != null && (g11 = fVar15.g()) != null) {
                            l10 = Long.valueOf(g11.getStart());
                        }
                        if (l10 == null) {
                            t9.i.q();
                        }
                        j10 = l10.longValue();
                        l8.f fVar16 = e.this.f16307z;
                        if (fVar16 != null && (g10 = fVar16.g()) != null) {
                            g10.setStart(0L);
                        }
                    } else {
                        j10 = 0;
    ...
    */
    public final int V0(String str) {
        ...
        l8.f fVar = this.f16307z;
        if (fVar != null && !fVar.p()) {
            NativeJni.c().w(this.f16296o, str);
        }
        l8.f fVar2 = this.f16307z;
        if (!t9.i.b((fVar2 == null || (g10 = fVar2.g()) == null) ? null : g10.getBuss(), "vod")) {
            l8.f fVar3 = this.f16307z;
        }
        ThumbnailUtil.INSTANCE.reset();
        PreviewUtil.INSTANCE.recycle();
        ThumbnailRequest.INSTANCE.cancel();
        this.D.lock();
        try {
            l8.f fVar4 = this.f16307z;
            if (fVar4 != null) {
    ...
    */
    public final String k0(String str) {
        ...
        if (s.l(str, "s", false, 2, null)) {
            str = str.substring(1);
            t9.i.c(str, "(this as java.lang.String).substring(startIndex)");
        }
        IMediaPlayer iMediaPlayer2 = this.f16295n;
        if ((iMediaPlayer2 instanceof AndroidMediaPlayer) || (iMediaPlayer2 instanceof ExoMediaPlayer)) {
            return str;
        }
        int y10 = t.y(str, Operator.Operation.EMPTY_PARAM, 0, false, 6, null);
        if (y10 == -1) {
            str2 = str;
        } else {
            if (str == null) {
                throw new h9.q("null cannot be cast to non-null type java.lang.String");
            }
            str2 = str.substring(0, y10);
            t9.i.c(str2, "(this as java.lang.Strin…ing(startIndex, endIndex)");
        }
        if (s.d(str2, ".m3u8", true)) {
            return str;
        }
        ...
        if (this.f16295n != null) {
            if (m0()) {
                ...
                if (iMediaPlayer2 instanceof AndroidMediaPlayer) {
                    ...
                    NativeJni.c().l(this.f16296o, "stop", "stop", 0);
                    iMediaPlayer = this.f16295n;
                    if (iMediaPlayer != null) {
                        iMediaPlayer.release();
                    }
                    NativeJni.c().l(this.f16296o, "release", "release", 0);
                    StringBuilder sb = new StringBuilder();
                    sb.append("mediaPlayer has release;");
                    sb.append(this);
                }
            }
            IMediaPlayer iMediaPlayer3 = this.f16295n;
            ...
            sb2.append("mediaPlayer has release;");
            sb2.append(this);
        }
        this.f16300s = false;
        this.f16295n = null;
