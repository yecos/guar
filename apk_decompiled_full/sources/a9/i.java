    ...
    public class e implements b.a, Runnable {
        ...
        */
        public void windowUpdate(int i10, long j10) {
            boolean z10;
            this.f428a.k(j.a.INBOUND, i10, j10);
            if (j10 == 0) {
                if (i10 == 0) {
                    i.this.f0(c9.a.PROTOCOL_ERROR, "Received 0 flow control window increment.");
                    return;
                } else {
                    i.this.U(i10, k1.f19903t.r("Received 0 flow control window increment."), r.a.PROCESSED, false, c9.a.PROTOCOL_ERROR, null);
                    return;
                }
            }
            synchronized (i.this.f405k) {
                if (i10 == 0) {
                    i.this.f404j.g(null, (int) j10);
                    return;
                }
                h hVar = (h) i.this.f408n.get(Integer.valueOf(i10));
                if (hVar != null) {
                    i.this.f404j.g(hVar.t().b0(), (int) j10);
                } else if (!i.this.c0(i10)) {
                    z10 = true;
                    if (z10) {
                        return;
                    }
                    i.this.f0(c9.a.PROTOCOL_ERROR, "Received window_update for unknown stream: " + i10);
                    return;
                }
                z10 = false;
                if (z10) {
