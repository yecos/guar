        ...
        public void c(SSLSocket sSLSocket, String str, List list) {
            ...
            if (str != null) {
                try {
                    try {
                        if (k.g(str)) {
                            Method method2 = f455k;
                            if (method2 == null || !((Boolean) method2.invoke(null, sSLSocket)).booleanValue()) {
                                f449e.e(sSLSocket, Boolean.TRUE);
                            } else {
                                f456l.invoke(null, sSLSocket, Boolean.TRUE);
                            }
                            Method method3 = f460p;
                            if (method3 == null || (constructor = f461q) == null) {
                                f450f.e(sSLSocket, str);
                            } else {
            ...
            Method method4 = f459o;
            if (method4 != null) {
                try {
                    method4.invoke(sSLSocket, new Object[0]);
                    f457m.invoke(sSLParameters, i10);
                    z10 = true;
                } catch (InvocationTargetException e13) {
                    if (!(e13.getTargetException() instanceof UnsupportedOperationException)) {
                        throw e13;
                    }
                    k.f445b.log(Level.FINER, "setApplicationProtocol unsupported, will try old methods");
                }
                sSLSocket.setSSLParameters(sSLParameters);
                if (z10 || (method = f458n) == null || !Arrays.equals(i10, (String[]) method.invoke(sSLSocket.getSSLParameters(), new Object[0]))) {
                    Object[] objArr = {b9.h.b(list)};
                    if (this.f448a.i() == h.EnumC0076h.ALPN_AND_NPN) {
                        f452h.f(sSLSocket, objArr);
                    }
                    if (this.f448a.i() != h.EnumC0076h.NONE) {
                        throw new RuntimeException("We can not do TLS handshake on this Android version, please install the Google Play Services Dynamic Security Provider to use TLS");
                    }
                    f454j.f(sSLSocket, objArr);
                    return;
                }
                return;
            }
