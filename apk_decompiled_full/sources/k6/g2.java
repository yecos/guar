...
public final class g2 implements i6.f0 {
    ...
    public static final class t extends t9.j implements s9.l {
        ...
        */
        public final Boolean invoke(StartPlayVODResult startPlayVODResult) {
            List<EpisodeList> episodeList;
            EpisodeList episodeList2;
            List<EpisodeList> episodeList3;
            EpisodeList episodeList4;
            t9.i.g(startPlayVODResult, "it");
            StartPlayVODData data = startPlayVODResult.getData();
            List<TotalMovieList> list = null;
            List<EpisodeList> episodeList5 = data != null ? data.getEpisodeList() : null;
            if (!(episodeList5 == null || episodeList5.isEmpty())) {
                StartPlayVODData data2 = startPlayVODResult.getData();
                List<TotalMovieList> totalMovieList = (data2 == null || (episodeList3 = data2.getEpisodeList()) == null || (episodeList4 = episodeList3.get(0)) == null) ? null : episodeList4.getTotalMovieList();
            }
            g0.b.a(g2.this.f0(), null, true, 1, null);
            StartPlayVODData data3 = startPlayVODResult.getData();
            if (data3 != null && (episodeList = data3.getEpisodeList()) != null && (episodeList2 = episodeList.get(0)) != null) {
                list = episodeList2.getTotalMovieList();
            }
            return Boolean.valueOf(com.mobile.brasiltv.utils.b0.I(list));
        }
    }
