        ...
        */
        public void handleGoogleAccountNotBind(String str, String str2) {
            ...
            if (com.mobile.brasiltv.utils.b0.T(this.f15339b, "0")) {
                try {
                    str3 = new JSONObject(str2).getString("localUserIdentity");
                    t9.i.f(str3, "JSONObject(errorData).ge…ring(\"localUserIdentity\")");
                    try {
                        str4 = new JSONObject(str2).getString("bindGoogleEmail");
                        t9.i.f(str4, "JSONObject(errorData).getString(\"bindGoogleEmail\")");
                        try {
                            String string = new JSONObject(str2).getString("googleEmail");
                            t9.i.f(string, "JSONObject(errorData).getString(\"googleEmail\")");
                            str5 = string;
                        } catch (Exception e10) {
                            e = e10;
                            e.printStackTrace();
                            if (!com.mobile.brasiltv.utils.b0.J(str3)) {
                            }
                        }
                    } catch (Exception e11) {
                        e = e11;
                ...
                if (!com.mobile.brasiltv.utils.b0.T(str3, "1") && !d6.b.f12660a.t()) {
                    j0.this.H().q();
                    j0.this.H().U1();
                } else if (com.mobile.brasiltv.utils.b0.T(str4, "0")) {
                    j0.this.H().S(this.f15340c, "1", this.f15342e);
                } else if (com.mobile.brasiltv.utils.b0.T(str4, "1")) {
                    j0.this.H().F2(str5, this.f15340c, "1", this.f15342e);
                }
            }
        }
