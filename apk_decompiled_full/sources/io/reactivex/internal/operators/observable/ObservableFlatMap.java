        ...
        public void drainLoop() {
            ...
            while (!checkTerminate()) {
                ...
                if (length != 0) {
                    ...
                    if (length <= i14 || innerObserverArr[i14].id != j10) {
                        if (length <= i14) {
                            i14 = 0;
                        }
                        for (int i15 = 0; i15 < length && innerObserverArr[i14].id != j10; i15++) {
                            i14++;
                            if (i14 == length) {
                                i14 = 0;
                            }
                        ...
                        this.lastIndex = i14;
                        this.lastId = innerObserverArr[i14].id;
                    }
                    int i16 = 0;
                    while (i11 < length) {
                        if (checkTerminate()) {
                        ...
                        InnerObserver<T, U> innerObserver = innerObserverArr[i14];
