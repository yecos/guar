...
public abstract class j {
    ...
    */
    public static Animator b(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet, AnimatorSet animatorSet, int i10, float f10) {
        int i11;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        if (name.equals("set")) {
                            ...
                            TypedArray k10 = q.i.k(resources, theme, attributeSet, x0.a.f19297h);
                            b(context, resources, theme, xmlPullParser, attributeSet, animatorSet2, q.i.g(k10, xmlPullParser, "ordering", 0, 0), f10);
                            k10.recycle();
