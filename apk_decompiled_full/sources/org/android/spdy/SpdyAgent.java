...
public final class SpdyAgent {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public SpdySession createSession(String str, String str2, Object obj, SessionCb sessionCb, SslCertcb sslCertcb, int i10, int i11, int i12, String str3) {
        String str4;
        byte[] bArr;
        char c10;
        ...
        if (str != null) {
            ...
            if (split.length != 1) {
                ...
                str4 = str;
                c10 = (char) Integer.parseInt(split2[1]);
                bArr = bytes3;
            } else {
                str4 = str + "/0.0.0.0:0";
                bArr = bytes2;
            ...
            lock2.lock();
            try {
                SpdySession spdySession3 = spdyAgent.sessionMgr.get(str4 + str2 + i10);
                ...
                try {
                    str5 = str4;
                    spdySession2 = new SpdySession(0L, this, str4, str2, sessionCb, i10, i11, obj);
                    bytes = str3 == null ? null : str3.getBytes();
                    domainHashIndex = spdyAgent.getDomainHashIndex(str2 + i10);
                } catch (Throwable th) {
                    th = th;
                }
                try {
                    if (spdyAgent.proxyUsername != null) {
                        try {
                            if (spdyAgent.proxyPassword != null) {
                                createSessionN = createSessionN(spdyAgent.agentNativePtr, spdySession2, domainHashIndex, substring.getBytes(), (char) Integer.parseInt(substring2), bArr, c10, spdyAgent.proxyUsername.getBytes(), spdyAgent.proxyPassword.getBytes(), obj, i10, i11, i12, bytes);
                                spduLog.Logi("tnet-jni", " create new session: " + str);
                                if ((createSessionN & 1) != 1) {
                                    i13 = (int) (createSessionN >> 1);
                                    createSessionN = 0;
                                } else {
                                    i13 = 0;
                                }
                                if (createSessionN == 0) {
                                    ...
                                    this.sessionMgr.put(str5 + str2 + i10, spdySession2);
                ...
                spdyAgent = this;
                createSessionN = createSessionN(spdyAgent.agentNativePtr, spdySession2, domainHashIndex, substring.getBytes(), (char) Integer.parseInt(substring2), bArr, c10, null, null, obj, i10, i11, i12, bytes);
                spduLog.Logi("tnet-jni", " create new session: " + str);
                if ((createSessionN & 1) != 1) {
                }
            } catch (Throwable th4) {
