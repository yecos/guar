...
public final class ReportHardInfoBean {
    ...
    */
    public /* synthetic */ ReportHardInfoBean(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, int i10, g gVar) {
        this(str, str2, str3, str4, str5, str6, str7, str8, str9, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23);
        String str21;
        String str22;
        String str23;
        String str24;
        ...
        if ((i10 & 512) != 0) {
            ...
            str21 = str32 == null ? "unknown" : str32;
        } else {
            str21 = str10;
        }
        if ((i10 & 1024) != 0) {
            String str33 = Build.BRAND;
            str22 = str33 == null ? "unknown" : str33;
        } else {
            str22 = str11;
        }
        if ((i10 & 2048) != 0) {
            String str34 = Build.ID;
            str23 = str34 == null ? "unknown" : str34;
        } else {
            str23 = str12;
        }
        if ((i10 & 4096) != 0) {
            String str35 = Build.CPU_ABI;
            str24 = str35 == null ? "unknown" : str35;
        } else {
            str24 = str13;
        }
        if ((i10 & 8192) != 0) {
            String str36 = Build.HARDWARE;
            str25 = str36 == null ? "unknown" : str36;
        } else {
            str25 = str14;
        }
        if ((i10 & 16384) != 0) {
            String str37 = Build.MANUFACTURER;
            str26 = str37 == null ? "unknown" : str37;
        } else {
            str26 = str15;
        }
        if ((32768 & i10) != 0) {
            String str38 = Build.FINGERPRINT;
            str27 = str38 == null ? "unknown" : str38;
        } else {
            str27 = str16;
        }
        if ((65536 & i10) != 0) {
            String str39 = Build.HOST;
            str28 = str39 == null ? "unknown" : str39;
        } else {
            str28 = str17;
        }
        if ((131072 & i10) != 0) {
            String str40 = Build.DEVICE;
            str29 = str40 == null ? "unknown" : str40;
        } else {
            str29 = str18;
        }
        if ((262144 & i10) != 0) {
            String str41 = Build.BOARD;
            str30 = str41 == null ? "unknown" : str41;
        } else {
            str30 = str19;
        }
        if ((i10 & 524288) != 0) {
            String str42 = Build.TAGS;
            str31 = str42 == null ? "unknown" : str42;
        } else {
            str31 = str20;
        }
    }
