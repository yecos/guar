...
public class h extends b {
    ...
    */
    public final void h1(int i10, int i11) {
        ...
        while (i12 < i10) {
            ...
            int i15 = i12 - i13;
            if (i15 > 0) {
                this.f13621r.write(cArr, i13, i15);
                if (i12 >= i10) {
                    return;
                }
            }
            i12++;
            i13 = O0(this.f13623t, i12, i10, c10, i14);
        }
    }
    ...
    */
    public final void m1(int i10, int i11) {
        ...
        int i13;
        int i14;
        int i15 = this.f13625v + i10;
        int[] iArr = this.f13567l;
        int min = Math.min(iArr.length, i11 + 1);
        while (this.f13625v < i15) {
            do {
                char[] cArr = this.f13623t;
                int i16 = this.f13625v;
                char c10 = cArr[i16];
                if (c10 < min) {
                    i12 = iArr[c10];
                    if (i12 != 0) {
                        int i17 = this.f13624u;
                        i13 = i16 - i17;
                        if (i13 <= 0) {
                            this.f13621r.write(cArr, i17, i13);
                        }
                        this.f13625v++;
                        P0(c10, i12);
                    }
    ...
    */
    public final void n1(char[] cArr, int i10, int i11, int i12) {
        ...
        while (i10 < i13) {
            ...
            int i16 = i15 - i10;
            if (i16 < 32) {
                if (this.f13625v + i16 > this.f13626w) {
                    N0();
                }
                if (i16 > 0) {
                    System.arraycopy(cArr, i10, this.f13623t, this.f13625v, i16);
                    this.f13625v += i16;
                }
            } else {
                N0();
                this.f13621r.write(cArr, i10, i16);
            }
            if (i15 >= i13) {
                return;
            }
