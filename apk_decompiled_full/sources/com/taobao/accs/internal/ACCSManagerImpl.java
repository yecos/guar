...
public class ACCSManagerImpl implements com.taobao.accs.b {
    ...
    */
    public void a(Context context, String str, String str2, String str3, IAppReceiver iAppReceiver) {
        ...
        ALog.i(f9136c, "bindApp", Constants.KEY_APP_KEY, str);
        Message buildParameterError = Message.buildParameterError(context.getPackageName(), 1);
        if (UtilityImpl.d(context)) {
            ALog.e(f9136c, "accs disabled, try enable", new Object[0]);
            UtilityImpl.focusEnableService(context);
        }
        if (TextUtils.isEmpty(str)) {
            this.f9139d.a(buildParameterError, -14);
            return;
        }
        this.f9139d.c(str3);
        this.f9139d.d(str);
        ...
        Intent b10 = b(context, 1);
        if (b10 == null) {
            return;
        }
        try {
            String str4 = GlobalClientInfo.getInstance(context).getPackageInfo().versionName;
            if (!UtilityImpl.c(context) && !UtilityImpl.a(Constants.SP_FILE_NAME, context) && !UtilityImpl.b(Constants.SP_FILE_NAME, context) && !Config.a()) {
                z10 = false;
                if (z10) {
                    ALog.d(f9136c, "bindApp", "need force bind");
                    b10.putExtra(Constants.KEY_FOUCE_BIND, true);
                }
                b10.putExtra(Constants.KEY_APP_KEY, str);
                b10.putExtra(Constants.KEY_TTID, str3);
                b10.putExtra("appVersion", str4);
                if (TextUtils.isEmpty(str2)) {
                    str2 = this.f9139d.d();
                }
                b10.putExtra("app_sercet", str2);
                if (!UtilityImpl.isMainProcess(context)) {
                    Message buildBindApp = Message.buildBindApp(this.f9139d.b((String) null), this.f9138b, context, b10);
                    ...
                    a(context, buildBindApp, 1, z10);
                } else {
                    ALog.w(f9136c, "bindApp only allow in main process", new Object[0]);
                }
                this.f9139d.b();
            }
            z10 = true;
            ...
            ALog.e(f9136c, "bindApp exception", th, new Object[0]);
        }
    }
    ...
    */
    public String a(Context context, ACCSManager.AccsRequest accsRequest) {
        ...
        try {
            ...
            ALog.e(f9136c, "sendData", th, "dataid", accsRequest.dataId);
        }
        if (!UtilityImpl.isMainProcess(context)) {
            ALog.e(f9136c, "sendData not in mainprocess", new Object[0]);
            return null;
        }
        if (!d10 && accsRequest != null) {
            if (TextUtils.isEmpty(this.f9139d.c())) {
                ...
                ALog.e(f9136c, "sendData appkey null", new Object[0]);
                return null;
            }
            this.f9139d.a();
            Message buildSendData = Message.buildSendData(this.f9139d.b((String) null), this.f9138b, this.f9139d.e(), context, context.getPackageName(), accsRequest);
            ...
            if (ALog.isPrintLog(ALog.Level.D) || "accs-impaas".equals(buildSendData.serviceId)) {
                ALog.e(f9136c, "sendMessage", Constants.KEY_DATA_ID, buildSendData.getDataId());
            }
            this.f9139d.a(buildSendData, true);
            return accsRequest.dataId;
        }
        k.a("accs", BaseMonitor.ALARM_POINT_REQ_ERROR, "", "1", "data null");
        ALog.e(f9136c, "sendData dataInfo null or disable:" + d10, new Object[0]);
        return null;
    }
