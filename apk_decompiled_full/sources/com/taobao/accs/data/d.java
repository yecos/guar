...
public class d {
    ...
    */
    private void a(int i10, byte[] bArr, String str, int i11) {
        String str2;
        String str3;
        String str4;
        String str5;
        ...
        ALog.Level level = ALog.Level.D;
        if (ALog.isPrintLog(level)) {
            String str22 = this.f9115m;
            String str23 = "flag:" + Integer.toHexString((int) b10);
            str2 = BaseMonitor.ALARM_POINT_REQ_ERROR;
            ALog.d(str22, str23, new Object[0]);
        } else {
            str2 = BaseMonitor.ALARM_POINT_REQ_ERROR;
        }
        String a10 = sVar.a(sVar.a());
        if (ALog.isPrintLog(level)) {
            str3 = "1";
            ALog.d(this.f9115m, "target:" + a10, new Object[0]);
        } else {
            str3 = "1";
        }
        String a11 = sVar.a(sVar.a());
        if (ALog.isPrintLog(level)) {
            str4 = "";
            ALog.d(this.f9115m, "source:" + a11, new Object[0]);
        } else {
            str4 = "";
        }
        try {
            String a12 = sVar.a(sVar.a());
            if (ALog.isPrintLog(level)) {
                str5 = "accs";
                ALog.d(this.f9115m, "dataId:" + a12, new Object[0]);
            } else {
                str5 = "accs";
            }
            if (!a11.contains(Constants.TARGET_SERVICE_ST) && !a11.contains(Constants.TARGET_FORE) && !a11.contains(Constants.TARGET_BACK)) {
                String str24 = a11 + a12;
                if (sVar.available() > 0) {
                    if (i11 == 2) {
                        ?? a13 = a(sVar);
                        if (a13 != 0 && a13.containsKey(16) && a13.containsKey(17)) {
                            str6 = a13;
                            z15 = true;
                        } else {
                            str6 = a13;
                ...
                try {
                    if (bArr2 == null) {
                        str9 = str6;
                        str10 = a11;
                        ALog.d(this.f9115m, "oriData is null", new Object[0]);
                    } else {
                        str9 = str6;
                        str10 = a11;
                        if (ALog.isPrintLog(level)) {
                            ALog.d(this.f9115m, "oriData:" + String.valueOf(bArr2), new Object[0]);
                        }
                    }
                    int valueOf = Message.MsgType.valueOf((int) ((b10 >> 15) & 1));
                    Message.ReqType valueOf2 = Message.ReqType.valueOf((int) ((b10 >> 13) & 3));
                    int i17 = (int) ((b10 >> 12) & 1);
                    int valueOf3 = Message.MsgResType.valueOf((int) ((b10 >> 11) & 1));
                    boolean z16 = ((int) ((b10 >> 6) & 1)) == 1;
                    try {
                        if (!ALog.isPrintLog(ALog.Level.I) && !a10.contains("accs-impaas")) {
                            z11 = z16;
                            i12 = 1;
                            if (valueOf == i12 || !(valueOf2 == Message.ReqType.ACK || valueOf2 == Message.ReqType.RES)) {
                                str11 = str9;
                                str12 = "handleMessage";
                                bArr3 = bArr2;
                                i13 = valueOf3;
                                ...
                                j10 = b10;
                                z12 = z11;
                                str14 = GlobalClientInfo.AGOO_SERVICE_ID;
                            } else {
                                try {
                                    Message remove = this.f9109g.remove(new Message.Id(0, a12));
                                    if (remove != null) {
                                        if (ALog.isPrintLog(level)) {
                                            str13 = "accs-impaas";
                                            ALog.d(this.f9115m, "handleMessage reqMessage not null", new Object[0]);
                                        } else {
                                            str13 = "accs-impaas";
                                        }
                                        if (i17 == 1) {
                                            try {
                                                i16 = new JSONObject(new String(bArr2)).getInt(Constants.KEY_HTTP_CODE);
                                        ...
                                        if (valueOf2 == Message.ReqType.RES) {
                                            ...
                                            message = remove;
                                            z12 = z11;
                                            a(remove, i16, valueOf2, bArr3, r52);
                                            str21 = r52;
                                        } else {
                                            ?? r53 = str9;
                                            message = remove;
                                        ...
                                        String str25 = message.serviceId;
                                        boolean isAppBackground = GlobalAppRuntimeInfo.isAppBackground();
                                        i13 = valueOf3;
                                        long length = bArr.length;
                                        str11 = str21;
                                        str14 = GlobalClientInfo.AGOO_SERVICE_ID;
                                        a(new TrafficsMonitor.a(str25, isAppBackground, str, length));
                                    } else {
                                        str11 = str9;
                                        i13 = valueOf3;
                                        str13 = "accs-impaas";
                                        ...
                                        bArr3 = bArr2;
                                        str14 = GlobalClientInfo.AGOO_SERVICE_ID;
                                        ALog.e(this.f9115m, "handleMessage data ack/res reqMessage is null", Constants.KEY_DATA_ID, a12);
                                    }
                                } catch (Exception e10) {
                                    e = e10;
                                    r22 = str3;
                                    ...
                                    r12 = str5;
                                    str7 = "handleMessage";
                                    ALog.e(this.f9115m, str7, e, new Object[0]);
                                    com.taobao.accs.utl.k.a(r12, str2, str8, r22, this.f9104b + e.toString());
                                    return;
                                }
                            }
                            if (valueOf == 0 || valueOf2 != Message.ReqType.RES) {
                                ...
                                Message remove2 = this.f9109g.remove(new Message.Id(0, a12));
                                if (remove2 != null) {
                                    a(remove2, bArr3, bArr, str);
                                    return;
                                }
                                str8 = str;
                                byte[] bArr6 = bArr3;
                                ALog.e(this.f9115m, "handleMessage contorl ACK reqMessage is null", Constants.KEY_DATA_ID, a12);
                                r22 = bArr6;
                                if (ALog.isPrintLog(ALog.Level.D)) {
                                    ALog.d(this.f9115m, "handleMessage not handled", "body", new String(bArr6));
                                    r22 = bArr6;
                                }
                            }
                            ...
                            if (a10 == null) {
                                ALog.e(this.f9115m, "handleMessage target is null", new Object[0]);
                                return;
                            }
                            String[] split = a10.split("\\|");
                            if (split.length < 2) {
                                ALog.e(this.f9115m, "handleMessage target length is invalid", new Object[0]);
                                return;
                            }
                            r12 = ALog.Level.D;
                            if (ALog.isPrintLog(r12)) {
                                ALog.d(this.f9115m, "handleMessage onPush", "isBurstData", Boolean.valueOf(z10));
                            }
                            com.taobao.accs.ut.a.d dVar2 = this.f9112j;
                            if (dVar2 != null) {
                                dVar2.a();
                            }
                            com.taobao.accs.ut.a.d dVar3 = new com.taobao.accs.ut.a.d();
                            this.f9112j = dVar3;
                            dVar3.f9277c = String.valueOf(System.currentTimeMillis());
                            try {
                                if (UtilityImpl.a(this.f9111i, split[1])) {
                                    String str26 = split.length >= 3 ? split[2] : null;
                                    this.f9112j.f9279e = str26;
                                    String str27 = str14;
                                    try {
                                        if (str27.equals(str26)) {
                                            ...
                                            str15 = str24;
                                            if (c(str15)) {
                                                ALog.e(this.f9115m, "handleMessage msg duplicate", Constants.KEY_DATA_ID, a12);
                                                this.f9112j.f9282h = true;
                                                str16 = str5;
                                                i14 = i13;
                                                str20 = str10;
                                                j13 = j10;
                                                ...
                                                if (!str16.equals(str26) && !str13.equals(str26)) {
                                                    ALog.i(this.f9115m, "handleMessage try sendAck dataId", Constants.KEY_DATA_ID, a12);
                                                    String str28 = str16;
                                                    str8 = str4;
                                                    double d11 = d10;
                                                    z14 = z13;
                                                    ...
                                                    str7 = str12;
                                                    String str30 = str26;
                                                    Message buildPushAck = Message.buildPushAck(this.f9114l.b((String) null), this.f9114l.d(), a10, str20, a12, false, (short) j13, str, str11);
                                                    this.f9114l.b(buildPushAck, true);
                                                    a(buildPushAck.dataId, str30);
                                                    r12 = str28;
                                                    r22 = str29;
                                                    if (z14) {
                                                        com.taobao.accs.utl.k.a(str28, BaseMonitor.COUNT_ACK, str8, d11);
                                                        r12 = str28;
                                                        r22 = str29;
                                                    }
                                                }
                                                ALog.e(this.f9115m, "handleMessage try sendAck dataId", Constants.KEY_DATA_ID, a12);
                                                String str282 = str16;
                                                str8 = str4;
                                                double d112 = d10;
                                                z14 = z13;
                                                ...
                                                str7 = str12;
                                                String str302 = str26;
                                                Message buildPushAck2 = Message.buildPushAck(this.f9114l.b((String) null), this.f9114l.d(), a10, str20, a12, false, (short) j13, str, str11);
                                                this.f9114l.b(buildPushAck2, true);
                                                a(buildPushAck2.dataId, str302);
                                                r12 = str282;
                                                r22 = str292;
                                                if (z14) {
                                                }
                                        ...
                                        sb.append(str19);
                                        dVar.f9280f = sb.toString();
                                        this.f9112j.f9275a = UtilityImpl.j(this.f9111i);
                                        this.f9112j.f9278d = String.valueOf(System.currentTimeMillis());
                                        str4 = str19;
                                        d10 = 0.0d;
                                        str20 = str18;
                                        str11 = r92;
                                        j13 = j12;
                                        a(new TrafficsMonitor.a(str26, GlobalAppRuntimeInfo.isAppBackground(), str, bArr.length));
                                        i14 = i13;
                                        i15 = 1;
                                        if (i14 == i15) {
                                        }
                                    ...
                                    if (z10) {
                                        ?? r93 = str11;
                                        byte[] a14 = a(str15, r93, r22);
                                        if (a14 == null) {
                                            ALog.e(this.f9115m, "handleMessage completeOriData is null", new Object[0]);
                                            return;
                                        }
                                        bArr4 = a14;
                                        r92 = r93;
                                        if (i10 == 1) {
                                            ...
                                            byte[] a15 = a(sVar2);
                                            if (ALog.isPrintLog(r12)) {
                                                ALog.d(this.f9115m, "handleMessage gzip completeOriData", Constants.KEY_DATA_ID, str15, "length", Integer.valueOf(a15.length));
                                            }
                                            sVar2.close();
                                            bArr4 = a15;
                                            r92 = r93;
                                    ...
                                    str16 = str5;
                                    if (str16.equals(str26)) {
                                        ALog.e(this.f9115m, "handleMessage try deliverMsg", Constants.KEY_DATA_ID, a12, "target", split[1], Constants.KEY_SERVICE_ID, str26);
                                    } else if (ALog.isPrintLog(ALog.Level.I)) {
                                        ALog.i(this.f9115m, "handleMessage try deliverMsg", Constants.KEY_DATA_ID, a12, "target", split[1], Constants.KEY_SERVICE_ID, str26);
                                    }
                                    Intent intent = new Intent(Constants.ACTION_RECEIVE);
                                    ...
                                    if (split.length >= 4) {
                                        str17 = split[3];
                                        intent.putExtra(Constants.KEY_USER_ID, str17);
                                    } else {
                                        str17 = str4;
                                    }
                                    intent.putExtra("data", bArr4);
                                    intent.putExtra(Constants.KEY_DATA_ID, a12);
                                    intent.putExtra(Constants.KEY_PACKAGE_NAME, this.f9111i.getPackageName());
                                    intent.putExtra(Constants.KEY_HOST, str8);
                                    intent.putExtra(Constants.KEY_CONN_TYPE, this.f9104b);
                                    z13 = z12;
                                    intent.putExtra(Constants.KEY_NEED_BUSINESS_ACK, z13);
                                    intent.putExtra(Constants.KEY_APP_KEY, this.f9114l.i());
                                    intent.putExtra(Constants.KEY_CONFIG_TAG, this.f9114l.f9169m);
                                    ...
                                    if (z13) {
                                        j11 = j10;
                                        str18 = str10;
                                        a(intent, str18, a10, (short) j11);
                                    } else {
                                        str18 = str10;
                                        j11 = j10;
                                    }
                                    j12 = j11;
                                    g.a().b(this.f9111i, intent);
                                    UTMini.getInstance().commitEvent(66001, "MsgToBussPush", "commandId=101", "serviceId=" + str26 + " dataId=" + a12, Integer.valueOf(Constants.SDK_VERSION_CODE));
                                    StringBuilder sb2 = new StringBuilder();
                                    sb2.append("1commandId=101serviceId=");
                                    sb2.append(str26);
                                    com.taobao.accs.utl.k.a(str16, BaseMonitor.COUNT_POINT_TO_BUSS, sb2.toString(), 0.0d);
                                    dVar = this.f9112j;
                                    dVar.f9276b = a12;
                                    dVar.f9283i = str17;
                                    ...
                                    str8 = str4;
                                    r12 = str5;
                                    ALog.e(this.f9115m, "handleMessage not exist, unbind it", Constants.KEY_PACKAGE, split[1]);
                                    com.taobao.accs.net.a aVar = this.f9114l;
                                    aVar.b(Message.buildUnbindApp(aVar.b((String) null), split[1]), true);
                                }
                                return;
                            } catch (Exception e12) {
                                e = e12;
                    ...
                    z11 = z16;
                    ALog.e(this.f9115m, "handleMessage", Constants.KEY_DATA_ID, a12, "type", Message.MsgType.name(valueOf), "reqType", valueOf2.name(), "resType", Message.MsgResType.name(valueOf3), "target", a10);
                    i12 = 1;
                } catch (Exception e14) {
                    e = e14;
                    str7 = "handleMessage";
                ...
                ALog.e(this.f9115m, "ignore source 4|sal|sg/fg/bg message dataId:" + a12, new Object[0]);
                this.f9109g.remove(new Message.Id(0, a12));
            }
        } catch (Exception e15) {
            ALog.e(this.f9115m, "dataId read error " + e15.toString(), new Object[0]);
            sVar.close();
            com.taobao.accs.utl.k.a("accs", str2, str4, str3, this.f9104b + "data id read error" + e15.toString());
        }
    }
