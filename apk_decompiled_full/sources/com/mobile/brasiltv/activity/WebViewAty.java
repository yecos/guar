    ...
    public static final class j extends WebViewClient {
        ...
        */
        public void onPageFinished(WebView webView, String str) {
            ...
            if (webView != null && webView.getProgress() == 100) {
                LollipopFixedWebView lollipopFixedWebView = (LollipopFixedWebView) WebViewAty.this.Y2(R$id.atyWebView);
                if (lollipopFixedWebView != null) {
                    lollipopFixedWebView.setVisibility(0);
                }
                if (this.f8259a) {
                    this.f8259a = false;
                    WebViewAty.this.v3(webView);
                }
            }
            if (webView != null && (r2 = webView.getTitle()) != null) {
                ...
                z10 = false;
                if (z10) {
                    ((TextView) webViewAty.Y2(R$id.atyWebViewTitle)).setText(" ");
                } else {
                    TextView textView = (TextView) webViewAty.Y2(R$id.atyWebViewTitle);
        ...
        */
        public void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
            ...
            String str = "";
            String str2 = (webResourceRequest == null || url2 == null || (path = url2.getPath()) == null) ? "" : path;
            if (webResourceRequest != null && url != null && (host = url.getHost()) != null) {
                str = host;
            }
            String a10 = a3.d.a(str, a3.d.f161a);
            t9.i.f(a10, "encryption(request?.url?…\"\", DESUtils.MAC_DES_KEY)");
            ...
            dVar.d(elapsedRealtime, elapsedRealtime, str2, a10, i10, (r23 & 32) != 0 ? "" : na.e.f17345e, (r23 & 64) != 0 ? null : null, true);
        }
        ...
        */
        public void onReceivedTitle(WebView webView, String str) {
            ...
            if (str != null) {
                ...
                boolean z10 = false;
                String str2 = " ";
                if (!t.o(str, "koocan.com", false, 2, null)) {
                    if ((webView != null ? webView.getTitle() : null) != null) {
                        ...
                        if (url != null) {
                            ...
                            t9.i.d(title2);
                            if (!t.o(url, title2, false, 2, null)) {
                                z10 = true;
                            }
                        }
                    }
