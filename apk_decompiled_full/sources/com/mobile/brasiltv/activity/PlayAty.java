...
public final class PlayAty extends f5.d implements g0, m6.a {
    ...
    */
    public final void t3(String str, int i10, String str2, String str3, int[] iArr) {
        boolean z10;
        TitanPlayerController titanPlayerController;
        TitanPlayerController titanPlayerController2;
        TitanPlayerController titanPlayerController3;
        TitanPlayerController titanPlayerController4;
        i.g(str, "programId");
        i.g(str2, "name");
        ArrayList arrayList = new ArrayList();
        PosterList posterList = new PosterList();
        posterList.setFileType(a7.d.f279a.g());
        posterList.setFileUrl(this.B);
        arrayList.add(posterList);
        if (iArr != null) {
            if (!(iArr.length == 0)) {
                z10 = true;
                SimpleProgramList simpleProgramList = new SimpleProgramList(this.f8018x, this.f8019y, "", "", "", "", !z10 ? iArr[0] : 1, false, "", arrayList, 0.0f, false, false, false, 14336, null);
                int i11 = R$id.mVodPlayer;
                titanPlayerController = (TitanPlayerController) a3(i11);
                if (titanPlayerController != null) {
                    titanPlayerController.V3(this.A, this.f8006l, simpleProgramList, this.f8007m);
                }
                ArrayList arrayList2 = new ArrayList();
                arrayList2.add(new SimpleProgramList(this.f8009o, this.f8019y, "", "", "", "", 1, true, "", arrayList, 0.0f, false, false, false, 14336, null));
                AssetData assetData = new AssetData(this.f8009o, this.f8019y, "", "", "", "", "", "", 0, 0, this.f8020z, "", "", "", "", 0.0f, "", "", "", "", "", 0, 0, 0, 0, "", "", "", "", "", arrayList2, arrayList, null);
                p3(this.f8012r);
                ((KoocanEmptyView) a3(R$id.mPlayEmptyView)).setVisibility(8);
                a3(R$id.mInfoView).setVisibility(0);
                titanPlayerController2 = (TitanPlayerController) a3(i11);
                if (titanPlayerController2 != null) {
                    titanPlayerController2.t2(assetData);
                }
                S2().o0(this.f8009o, this.f8007m, this.f8008n, this.f8012r);
                S2().a0().clear();
                if (this.f8015u) {
                    h hVar = h.f8694a;
                    this.f8016v = i.b(hVar.f(), "480p") ? o6.c.c() : i.b(hVar.f(), "720p") ? o6.c.b() : o6.c.a();
                }
                titanPlayerController3 = (TitanPlayerController) a3(i11);
                if (titanPlayerController3 != null) {
                    titanPlayerController3.setVodQualityVisibility(8);
                }
                titanPlayerController4 = (TitanPlayerController) a3(i11);
                if (titanPlayerController4 != null) {
                    titanPlayerController4.setVodSubtitleAudioVisibility(8);
                }
                H = str2;
                S2().a(this.f8009o, str, this.f8014t, this.f8007m, this.f8016v.c(), this.f8012r, this.f8013s, this.f8015u, str3, iArr, true);
                I = (!i.b("movie", this.f8008n) || i.b("1", this.f8007m)) ? "" : String.valueOf(i10);
            }
        }
        z10 = false;
        SimpleProgramList simpleProgramList2 = new SimpleProgramList(this.f8018x, this.f8019y, "", "", "", "", !z10 ? iArr[0] : 1, false, "", arrayList, 0.0f, false, false, false, 14336, null);
        int i112 = R$id.mVodPlayer;
        titanPlayerController = (TitanPlayerController) a3(i112);
        if (titanPlayerController != null) {
        }
        ArrayList arrayList22 = new ArrayList();
        arrayList22.add(new SimpleProgramList(this.f8009o, this.f8019y, "", "", "", "", 1, true, "", arrayList, 0.0f, false, false, false, 14336, null));
        AssetData assetData2 = new AssetData(this.f8009o, this.f8019y, "", "", "", "", "", "", 0, 0, this.f8020z, "", "", "", "", 0.0f, "", "", "", "", "", 0, 0, 0, 0, "", "", "", "", "", arrayList22, arrayList, null);
        p3(this.f8012r);
        ((KoocanEmptyView) a3(R$id.mPlayEmptyView)).setVisibility(8);
        a3(R$id.mInfoView).setVisibility(0);
        titanPlayerController2 = (TitanPlayerController) a3(i112);
        if (titanPlayerController2 != null) {
        }
        S2().o0(this.f8009o, this.f8007m, this.f8008n, this.f8012r);
        S2().a0().clear();
        ...
        titanPlayerController3 = (TitanPlayerController) a3(i112);
        if (titanPlayerController3 != null) {
        }
        titanPlayerController4 = (TitanPlayerController) a3(i112);
        if (titanPlayerController4 != null) {
        }
        H = str2;
        S2().a(this.f8009o, str, this.f8014t, this.f8007m, this.f8016v.c(), this.f8012r, this.f8013s, this.f8015u, str3, iArr, true);
