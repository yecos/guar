...
public final class CastModeAty extends f5.c implements c.b, c.InterfaceC0353c {
    ...
    */
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.aty_cast_mode);
        String stringExtra = getIntent().getStringExtra("from_type");
        if (stringExtra == null) {
            stringExtra = "";
        }
        this.f7825k = stringExtra;
        this.f7826l = getIntent().getBooleanExtra("experience_mode", false);
        String stringExtra2 = getIntent().getStringExtra("cast_video_encode_format");
        if (stringExtra2 == null) {
            stringExtra2 = "";
        }
        this.f7827m = stringExtra2;
        String stringExtra3 = getIntent().getStringExtra("cast_video_stream_format");
        this.f7828n = stringExtra3 != null ? stringExtra3 : "";
        i3();
        d3();
        this.f7832r = z5.c.f20224e.a(this);
        if (k3()) {
            this.f7832r = false;
        }
        if (this.f7832r) {
            this.f7831q = CastContext.getSharedInstance(this);
            this.f7830p = new z5.c();
            Context applicationContext = getApplicationContext();
            int i10 = R$id.mTvRealChromeCast;
            CastButtonFactory.setUpMediaRouteButton(applicationContext, (MediaRouteButton) X2(i10));
            CastContext castContext = this.f7831q;
            boolean z10 = castContext != null;
            if (z10) {
                return;
            }
            ((MediaRouteButton) X2(i10)).setVisibility(0);
        }
    }
