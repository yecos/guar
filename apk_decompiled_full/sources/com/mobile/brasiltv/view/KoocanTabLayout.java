...
public class KoocanTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener {
    ...
    public class PointEvaluator implements TypeEvaluator<IndicatorPoint> {
        ...
        public IndicatorPoint evaluate(float f10, IndicatorPoint indicatorPoint, IndicatorPoint indicatorPoint2) {
            ...
            IndicatorPoint indicatorPoint3 = KoocanTabLayout.this.new IndicatorPoint();
    ...
    private void calcOffset() {
        if (this.mTabsContainer.getChildAt(this.mCurrentTab) != null) {
            this.mCurrentP.left = r0.getLeft();
            this.mCurrentP.right = r0.getRight();
        }
        if (this.mTabsContainer.getChildAt(this.mLastTab) != null) {
            this.mLastP.left = r0.getLeft();
            this.mLastP.right = r0.getRight();
        }
