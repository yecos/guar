...
public class HttpDns implements HttpDnsService {
    ...
    public HTTPDNSResult getIpsByHostAsync(String str, Map<String, String> map, String str2) {
        ...
        if (!hostManager.m11a(str)) {
            if (!u.e()) {
                ...
                if (!str2.equals(m6a.getCacheKey())) {
                    return new HTTPDNSResult(str, f.f20c, map2);
                }
                if (this.isExpiredIPEnabled) {
                    reportHttpDnsSuccess(str, 1);
                    reportUserGetIP(str, 1);
                    return new HTTPDNSResult(str, m6a.getIps(), m6a.m15a());
                }
                if (m6a.c()) {
                    i.d("[HttpDns] ips from cache:" + Arrays.toString(m6a.getIps()));
                    return new HTTPDNSResult(str, m6a.getIps(), m6a.m15a());
                }
                if (z10) {
                ...
                i.d("[HttpDns] not expired return " + Arrays.toString(m6a.getIps()));
                reportHttpDnsSuccess(str, 1);
                reportUserGetIP(str, 1);
                return new HTTPDNSResult(str, m6a.getIps(), m6a.m15a());
            }
        ...
        if (m6a != null && !str2.equals(m6a.getCacheKey())) {
            if (!u.e()) {
                i.d("refresh host async: " + str);
                qVar = new q(str, s.QUERY_HOST, map2, str2);
                c.a().submit(qVar);
    ...
    */
    public String[] getIpsByHostAsync(String str) {
        ...
        if (m6a != null && m6a.getCacheKey() != null) {
            if (!u.e()) {
                i.d("refresh host async: " + str);
                qVar = new q(str, s.QUERY_HOST);
                c.a().submit(qVar);
