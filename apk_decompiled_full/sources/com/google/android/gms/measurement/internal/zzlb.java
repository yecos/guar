...
public final class zzlb extends zzgl {
    ...
    */
    public final int zza(String str, String str2, String str3, Object obj, Bundle bundle, List list, boolean z10, boolean z11) {
        int i10;
        int i11;
        int size;
        zzg();
        if (zzaf(obj)) {
            ...
            if (size > 200) {
                ...
                if (obj instanceof Bundle) {
                    zzW(str, str2, str3, (Bundle) obj, list, z10);
                    ...
                    for (Parcelable parcelable : (Parcelable[]) obj) {
                        ...
                        zzW(str, str2, str3, (Bundle) parcelable, list, z10);
                    }
                } else {
                    ...
                    for (int i12 = 0; i12 < size2; i12++) {
                        ...
                        zzW(str, str2, str3, (Bundle) obj2, list, z10);
                    }
                }
                return i10;
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Bundle zzy(String str, String str2, Bundle bundle, List list, boolean z10) {
        int i10;
        int i11;
        String str3;
        ...
        for (String str4 : new TreeSet(bundle.keySet())) {
            ...
            if (i10 != 0) {
                zzJ(bundle2, i10, str4, str4, i10 == 3 ? str4 : null);
                bundle2.remove(str4);
                i11 = zzc;
            } else {
                i11 = zzc;
                ...
                if (zza2 == 17) {
                    ...
                    if (zzai(str3)) {
                        int i13 = i12 + 1;
                        if (i13 > i11) {
                            this.zzt.zzay().zze().zzc("Event can't contain more than " + i11 + " params", this.zzt.zzj().zzd(str2), this.zzt.zzj().zzb(bundle));
                            zzao(bundle2, 5);
                            bundle2.remove(str3);
                        }
                        i12 = i13;
