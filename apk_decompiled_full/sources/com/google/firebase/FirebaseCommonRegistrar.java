...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public static /* synthetic */ String lambda$getComponents$2(Context context) {
        ...
        return context.getPackageManager().hasSystemFeature("android.hardware.type.television") ? "tv" : (i10 < 20 || !context.getPackageManager().hasSystemFeature("android.hardware.type.watch")) ? (i10 < 23 || !context.getPackageManager().hasSystemFeature("android.hardware.type.automotive")) ? (i10 < 26 || !context.getPackageManager().hasSystemFeature("android.hardware.type.embedded")) ? "" : "embedded" : ConnType.PK_AUTO : "watch";
    }
