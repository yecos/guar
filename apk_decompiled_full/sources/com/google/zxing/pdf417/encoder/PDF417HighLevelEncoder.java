...
final class PDF417HighLevelEncoder {
    ...
    */
    private static int determineConsecutiveBinaryCount(String str, int i10, Charset charset) {
        int i11;
        ...
        while (i12 < length) {
            ...
            int i13 = 0;
            while (i13 < 13 && isDigit(charAt) && (i11 = i12 + (i13 = i13 + 1)) < length) {
                charAt = str.charAt(i11);
            }
            char charAt2 = str.charAt(i12);
            if (!newEncoder.canEncode(charAt2)) {
                throw new WriterException("Non-encodable character detected: " + charAt2 + " (Unicode: " + ((int) charAt2) + ASCIIPropertyListParser.ARRAY_END_TOKEN);
            }
            i12++;
        }
        return i12 - i10;
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private static int encodeText(CharSequence charSequence, int i10, int i11, StringBuilder sb, int i12) {
            ...
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        ...
                        int i16 = i15 + 1;
                        if (i16 >= i11 || !isPunctuation(charSequence.charAt(i16))) {
                            sb2.append((char) 29);
                            sb2.append((char) PUNCTUATION[charAt]);
                        } else {
                            sb2.append((char) 25);
