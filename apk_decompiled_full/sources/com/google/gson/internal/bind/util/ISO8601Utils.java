    ...
    */
    public static Date parse(String str, ParsePosition parsePosition) {
        ...
        try {
            ...
            if (checkOffset(str, i14, ASCIIPropertyListParser.DATE_DATE_FIELD_DELIMITER)) {
                i14++;
            }
            int i15 = i14 + 2;
            int parseInt2 = parseInt(str, i14, i15);
            if (checkOffset(str, i15, ASCIIPropertyListParser.DATE_DATE_FIELD_DELIMITER)) {
                i15++;
            }
            int i16 = i15 + 2;
            int parseInt3 = parseInt(str, i15, i16);
            boolean checkOffset = checkOffset(str, i16, ASCIIPropertyListParser.DATE_APPLE_DATE_TIME_DELIMITER);
            ...
            if (checkOffset) {
                ...
                if (checkOffset(str, i18, ASCIIPropertyListParser.DATE_TIME_FIELD_DELIMITER)) {
                    i18++;
                }
                int i19 = i18 + 2;
                int parseInt5 = parseInt(str, i18, i19);
                if (checkOffset(str, i19, ASCIIPropertyListParser.DATE_TIME_FIELD_DELIMITER)) {
                    i19++;
                }
                if (str.length() > i19 && (charAt = str.charAt(i19)) != 'Z' && charAt != '+' && charAt != '-') {
                    ...
                    if (charAt2 == 'Z') {
                        ...
                        if (!"+0000".equals(substring) && !"+00:00".equals(substring)) {
                            ...
                            if (!id.equals(str3) && !id.replace(SOAP.DELIM, "").equals(str3)) {
