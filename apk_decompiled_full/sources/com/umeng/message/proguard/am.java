...
public final class am {
    ...
    */
    public final ap a() {
        ap apVar;
        boolean z10;
        UPushInAppMessageHandler inAppMessageHandler;
        synchronized (this.f11519c) {
            boolean z11 = false;
            while (true) {
                if (!this.f11519c.isEmpty()) {
                    apVar = this.f11519c.getFirst();
                    long j10 = ak.a().c().f11527e;
                    if (j10 <= 0) {
                        z10 = false;
                    } else {
                        z10 = System.currentTimeMillis() - apVar.f11536b <= j10;
                        if (!z10) {
                            UPLog.i("Pop", "msg time invalid", apVar.f11535a.getMsgId(), "received", new SimpleDateFormat("MM-dd HH:mm:ss", Locale.getDefault()).format(Long.valueOf(apVar.f11536b)), "valid", Long.valueOf((j10 / 1000) / 60));
                        }
                    }
                    if (z10 && ((inAppMessageHandler = v.a().getInAppMessageHandler()) == null || !inAppMessageHandler.isOnlyShowLatestMessage() || apVar.f11535a.getMsgTime() > MessageSharedPrefs.getInstance(y.a()).f11344b.b("ia_latest_ts", -1L))) {
                        break;
                    }
                    this.f11519c.remove(apVar);
                    UPLog.i("Pop", "get unShow msgId", apVar.f11535a.getMsgId());
                    try {
                        UPushInAppMessageHandler inAppMessageHandler2 = v.a().getInAppMessageHandler();
                        if (inAppMessageHandler2 != null) {
                            inAppMessageHandler2.onMessageIgnored(y.a(), apVar.f11535a);
                        }
                    } catch (Throwable th) {
                        UPLog.e("Pop", th);
                    }
