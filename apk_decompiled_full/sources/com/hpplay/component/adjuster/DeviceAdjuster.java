...
public class DeviceAdjuster {
    ...
    */
    public void filterDevices(int i10, Object obj) {
        try {
            ...
            if (!TextUtils.equals(jSONObject.optString(KEY_LELINK_UID), this.mParamsMap.getStringParam(ParamsMap.DeviceParams.KEY_UID)) && !TextUtils.equals(optString, this.mParamsMap.getIp()) && !TextUtils.equals(this.mParamsMap.getStringParam(ParamsMap.DeviceParams.KEY_SINK_NAME), optString2)) {
                CLog.i(TAG, " no find new devices name " + optString2 + " new dev  " + optString.replace(".", "") + " request " + this.mParamsMap.getIp());
                if (this.mCurrentType != convertType(i10)) {
                    if ((obj.toString().contains(this.mParamsMap.getStringParam(ParamsMap.DeviceParams.KEY_UID)) || obj.toString().contains(this.mParamsMap.getStringParam(ParamsMap.DeviceParams.KEY_SINK_NAME))) && !this.isFindDevice) {
                        CLog.i(TAG, "mCurrentType " + this.mCurrentType + "  type " + i10 + "   convert " + convertType(i10));
            ...
            CLog.i(TAG, " find new devices " + optString2 + "  type " + i10);
            this.mValidInfos.add(obj.toString());
            this.mInfos.put(String.valueOf(i10), this.mValidInfos);
            if (this.mCurrentType != convertType(i10)) {
            }
        } catch (Exception e10) {
            CLog.w(TAG, e10);
