...
public class Tokenizer {
    ...
    */
    public Token get(boolean z10, boolean z11) {
        int i10;
        ...
        while (true) {
            int i13 = getChar();
            if (i13 != -1 && this.delimiters.indexOf(i13) == -1) {
                if (i13 == 92) {
                    i13 = getChar();
                    if (i13 == -1) {
                        throw exception("unterminated escape sequence");
                    }
                    this.sb.append(ASCIIPropertyListParser.QUOTEDSTRING_ESCAPE_TOKEN);
                } else if (this.quoting && i13 == 10) {
                    throw exception("newline in quoted string");
                }
                this.sb.append((char) i13);
            } else {
                if (i13 == -1) {
                    if (this.quoting) {
                        throw exception("EOF in quoted string");
                    }
                    return this.sb.length() == 0 ? this.current.set(0, null) : this.current.set(i12, this.sb);
                }
                if (this.sb.length() != 0 || i12 == 4) {
                    break;
                }
                if (i13 == 40) {
                    this.multiline++;
                    ...
                    int i14 = this.multiline;
                    if (i14 <= 0) {
                        throw exception("invalid release parenthesis");
                    }
                    this.multiline = i14 - 1;
                    skipWhitespace();
                } else if (i13 == 34) {
                    if (this.quoting) {
                        this.quoting = false;
