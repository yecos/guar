...
public final class g1 extends y8.s0 {
    ...
    */
    public List d() {
        boolean z10;
        y8.h hVar;
        ArrayList arrayList = new ArrayList(this.f20601c);
        List a10 = y8.g0.a();
        if (a10 != null) {
        ...
        if (!z10 && this.f20624z) {
            try {
                ...
                hVar = (y8.h) cls.getDeclaredMethod("getClientInterceptor", cls2, cls2, cls2, cls2).invoke(null, Boolean.valueOf(this.A), Boolean.valueOf(this.B), Boolean.valueOf(this.C), Boolean.valueOf(this.D));
