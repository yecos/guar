...
public abstract class a extends d implements q, l1.d {
    ...
    public static abstract class c extends d.a {
        ...
        */
        public void E(y8.v0 v0Var) {
            boolean z10;
            String str;
            Preconditions.checkState(!this.f20261q, "Received headers on closed stream");
            this.f20253i.a();
            String str2 = (String) v0Var.g(q0.f20839g);
            if (this.f20256l && str2 != null) {
                if (str2.equalsIgnoreCase("gzip")) {
                    w(new r0());
                    z10 = true;
                    str = (String) v0Var.g(q0.f20837e);
                    if (str != null) {
                        y8.u e10 = this.f20257m.e(str);
                        if (e10 == null) {
                            d(y8.k1.f19903t.r(String.format("Can't find decompressor for %s", str)).d());
                            return;
                        } else if (e10 != l.b.f19933a) {
                            if (z10) {
                                d(y8.k1.f19903t.r("Full stream and gRPC message encoding cannot both be set").d());
                                return;
                            }
                            v(e10);
                        }
                ...
                if (!str2.equalsIgnoreCase("identity")) {
                    d(y8.k1.f19903t.r(String.format("Can't find full stream decompressor for %s", str2)).d());
                    return;
                }
            }
            z10 = false;
