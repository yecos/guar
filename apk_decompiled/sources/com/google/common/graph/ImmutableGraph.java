...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N n10) {
        ...
        return graph.isDirected() ? DirectedGraphConnections.ofImmutable(n10, graph.incidentEdges(n10), constant) : UndirectedGraphConnections.ofImmutable(Maps.asMap(graph.adjacentNodes(n10), constant));
    }
