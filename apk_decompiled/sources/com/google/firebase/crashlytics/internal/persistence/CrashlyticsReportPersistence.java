...
public class CrashlyticsReportPersistence {
    ...
    private static String generateEventFilename(int i10, boolean z10) {
        return "event" + String.format(Locale.US, EVENT_COUNTER_FORMAT, Integer.valueOf(i10)) + (z10 ? PRIORITY_EVENT_SUFFIX : "");
    }
    ...
    private void synthesizeReportFile(File file, List<CrashlyticsReport.Session.Event> list, long j10, boolean z10, String str) {
        try {
            ...
            writeTextFile(z10 ? this.fileStore.getPriorityReport(session.getIdentifier()) : this.fileStore.getReport(session.getIdentifier()), crashlyticsReportJsonTransform.reportToJson(withEvents));
        } catch (IOException e10) {
